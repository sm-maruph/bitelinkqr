...
export default function OfferSection({ onMenu, variant = 'light' }) {
  return <section className={`template-offer template-offer-${variant}`} aria-label="Special offer">
    ...
    <div><small>Limited-time table offer</small><h2>Save 20% on signature dishes</h2><p>Order two selected mains and enjoy the offer automatically at checkout.</p></div>
