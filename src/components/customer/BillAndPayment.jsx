...
export default function BillAndPayment({ order, payment, onPay }) {
  const fallbackItems = [
    { id: 'demo-kacchi', name: 'Special Mutton Kacchi', price: 350, quantity: 2 },
    { id: 'demo-borhani', name: 'Borhani', price: 60, quantity: 2 },
  ]
