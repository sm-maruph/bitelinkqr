...
export default function CustomerHero({ template, restaurantName, outlet, menuItems, currentPage, pageCount, onPageChange, onSelect, onAdd, onMenu, categories, category, onCategoryChange }) {
  if (template.startsWith('future-')) return <FuturisticLanding template={template} restaurantName={restaurantName} outlet={outlet} onMenu={onMenu} menuItems={menuItems} onSelect={onSelect} onAdd={onAdd} categories={categories} category={category} onCategoryChange={onCategoryChange} />
  ...
  if (template === 'express') return <ExpressLanding restaurantName={restaurantName} outlet={outlet} onMenu={onMenu} menuItems={menuItems} onSelect={onSelect} onAdd={onAdd} categories={categories} category={category} onCategoryChange={onCategoryChange} />
  if (template === 'worldplate') return <WorldPlateLanding restaurantName={restaurantName} outlet={outlet} onMenu={onMenu} menuItems={menuItems} onSelect={onSelect} onAdd={onAdd} categories={categories} category={category} onCategoryChange={onCategoryChange} />
  if (template === 'ember') return <EmberLanding restaurantName={restaurantName} outlet={outlet} onMenu={onMenu} menuItems={menuItems} onSelect={onSelect} onAdd={onAdd} categories={categories} category={category} onCategoryChange={onCategoryChange} />
  if (template === 'sage') return <SageLanding restaurantName={restaurantName} outlet={outlet} onMenu={onMenu} menuItems={menuItems} onSelect={onSelect} onAdd={onAdd} categories={categories} category={category} onCategoryChange={onCategoryChange} />
  return <>
